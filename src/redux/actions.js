...
export const removeTodoInternal = (id, listId) => ({
  type: REMOVE_TODO,
  id,
  listId,
});
export const addTodoWithId = (id, title, listId, isSaving = true) => ({
  type: ADD_TODO,
  id,
  title,
  listId,
...
export const moveTodoInListInternal = (id, listId, targetIndex) => ({
  type: MOVE_TODO_IN_LIST,
  id,
  listId,
  targetIndex,
});
export const changeTodoInternal = (id, newProps) => ({
  type: CHANGE_TODO,
  id,
  newProps,
});
export const clearCompletedTodosInternal = (listId) => ({
...
export const moveTodoInList =
  (id, listId, targetIndex) => (dispatch, getState) => {
